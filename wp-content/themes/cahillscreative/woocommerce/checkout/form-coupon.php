...
<form class="c-form-coupon u-space--top checkout_coupon woocommerce-form-coupon" method="post" style="display:none" id="woocommerce-checkout-form-coupon">
  <p><strong><?php esc_html_e( 'If you have a coupon code, please apply it below.', 'woocommerce' ); ?></strong></p>
  <div class="o-form--inline u-space--half--top">
