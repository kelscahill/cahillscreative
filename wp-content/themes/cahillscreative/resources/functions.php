...
if( function_exists('acf_add_local_field_group') ):
    ...
    'fields' => array(
      array(
        ...
        'layouts' => array(
          ...
          'layout_5e4c78f09ca0g' => array(
            'key' => 'layout_5e4c78f09ca0g',
            'name' => 'embed_section',
            'label' => 'Embed',
            'display' => 'row',
            'sub_fields' => array(
              array(
                'key' => 'field_5e4c9bccdd5dc',
                'label' => 'Embed Section Content',
                'name' => 'embed_section_content',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
          ...
          'layout_5f3edeaaebfa7' => array(
            'key' => 'layout_5f3edeaaebfa7',
            'name' => 'gallery_section',
            'label' => 'Gallery',
            'display' => 'block',
            'sub_fields' => array(
              array(
                'key' => 'field_1e4c79148db0e',
                'label' => 'Gallery Section Kicker',
                'name' => 'gallery_section_kicker',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
              ...
              array(
                'key' => 'field_5e0cabab4e651',
                'label' => 'Gallery Section CTA',
                'name' => 'gallery_section_cta',
                'type' => 'link',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
  ...
  acf_add_local_field_group(array(
    ...
    'fields' => array(
      ...
      array(
        'key' => 'field_59egaf15128ca',
        'label' => 'Affiliate Link Text',
        'name' => 'affiliate_link_text',
        'type' => 'text',
        'instructions' => '',
        'required' => '',
        'conditional_logic' => '',
