  ...
  if ( function_exists( 'acf_register_block_type' ) ) {
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => get_stylesheet_directory() . '/resources/views/blocks/accordion.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => get_stylesheet_directory() . '/resources/views/blocks/cards.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => get_stylesheet_directory() . '/resources/views/blocks/image-row.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => get_stylesheet_directory() . '/resources/views/blocks/newsletter.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => get_stylesheet_directory() . '/resources/views/blocks/posts-slider.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => get_stylesheet_directory() . '/resources/views/blocks/promo.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => get_stylesheet_directory() . '/resources/views/blocks/steps.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => get_stylesheet_directory() . '/resources/views/blocks/disclaimer.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
