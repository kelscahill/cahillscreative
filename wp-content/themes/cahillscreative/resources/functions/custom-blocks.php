  ...
  if ( function_exists( 'acf_register_block_type' ) ) {
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => '/resources/views/blocks/cards.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => '/resources/views/blocks/image-row.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => '/resources/views/blocks/newsletter.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => '/resources/views/blocks/posts-slider.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => '/resources/views/blocks/steps.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
    ...
    acf_register_block_type(
      array(
        ...
        'render_template' => '/resources/views/blocks/disclaimer.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
