      ...
      <article <?php  post_class('article spacing--double')  ?>>
        <div class="article__body spacing text-align--center">
          ...
          <?php if($posts->have_posts()): ?>
            ...
            <?php  echo do_shortcode('[ajax_load_more container_type="div" tag="home-decor" post_type="affiliate" scroll="true" transition_container="false" button_label="Load More Items" posts_per_page="12" offset="12"]');  ?>
          <?php else: ?>
