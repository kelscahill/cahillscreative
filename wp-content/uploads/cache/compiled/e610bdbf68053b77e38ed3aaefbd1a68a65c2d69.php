  ...
  <section class="section section__pagination background-color--off-white">
      ...
      <div class="pagination">
        <div class="pagination-item">
          <?php if(!empty($prev_post)): ?>
            <a href="<?php echo e($prev_post->guid); ?>" class="prev pagination-link">
        			<span class="icon icon--l"><?php echo $__env->make('patterns/arrow--carousel', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></span>
        ...
        <div class="pagination-item">
            ...
            <span class="icon icon--l"><?php echo $__env->make('patterns/icon--close--large', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></span>
