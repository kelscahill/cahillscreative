...
add_action('ptn_clear_bv_services_config', array($wp_action, 'clear_bv_services_config'));
...
if ((array_key_exists('bvplugname', $_REQUEST)) && ($_REQUEST['bvplugname'] == "pantheon")) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
	...
	$pubkey = isset($_REQUEST['pubkey']) ? PTNAccount::sanitizeKey(wp_unslash($_REQUEST['pubkey'])) : '';
