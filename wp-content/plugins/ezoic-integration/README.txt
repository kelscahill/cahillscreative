...
= 2.3 =
* Added feature for setting up ads.txt file with Ads.txt Manager

= 2.2.1 =
* Remove plugin filtering feature

= 2.2.0 =
* Added plugin filtering feature

= 2.1.3 =
* Changed speed settings so that potentially breaking features are off by default

= 2.1.2 =
* Fix to prevent speed settings from applying to admin pages

= 2.1.1 =
* Enabled microdata header for documentation

= 2.1.0 =
* Added several new options for speed optimization

= 2.0.6 =
* Bug fix for bloginfo WordPress hook

= 2.0.5 =
* Fixes for CDN cache clearing

= 2.0.4 =
* Add Ezoic domain verification

= 2.0.3 =
* Option to disable automatic WP integration

= 2.0.2 =
* Fix content filter / JSON errors

= 2.0.1 =
* Bug fix for WordPress hooks

= 2.0 =
* Implementation of Ezoic features
