...
class Ezoic_Integration_Compatibility_Check {
	...
	static $known_incompatible_plugins = array(
		...
		'Swift Performance Lite' => array(
			'versions' => 'all',
			'message' => 'Plugin must be disabled to utilize Ezoic without issues or conflicts. Sites can elect to use a whitelisted WP caching plugin; however, most WP caching plugins should be disabled when using Ezoic\'s Site Speed Accelerator or Leap. Fortunately, Site Speed Accelerator and Leap replaces all the functionality of these caching plugins and delivers better performance.'
		),
	...
	static $whitelisted_plugins = array(
		'W3 Total Cache' => array(
			'versions' => 'all',
			'message' => 'Ezoic\'s Site Speed Accelerator or Leap may require that these plugins be turned off or that all minification, caching, or "speed" optimizations are disabled to prevent conflicts. Site Speed Accelerator and Leap more optimally replaces the functionality of these plugins as it relates to site speed.'
		),
		...
		'WP Rocket' => array(
			'versions' => 'all',
			'message' => 'Ezoic\'s Site Speed Accelerator / Leap may require that these plugins be turned off or that all minification, caching, or "speed" optimizations are disabled to prevent conflicts. Site Speed Accelerator and Leap more optimally replaces the functionality of these plugins as it relates to site speed.'
		),
		'ShortPixel Image Optimizer' => array(
			'versions' => 'all',
			'message' => 'This plugin is no longer required when using Ezoic\'s Site Speed Accelerator or Leap, and may cause conflicts in performance. Ezoic performs all the paid features of this plugin and much more.'
		),
		'Imagify' => array(
			'versions' => 'all',
			'message' => 'This plugin is no longer required when using Ezoic\'s Site Speed Accelerator or Leap, and may cause conflicts in performance. Ezoic performs all the paid features of this plugin and much more.'
