...
namespace plainview\sdk_broadcast\form2\inputs\traits;

/**
	@brief		Value manipulation.
	@details	Values are saved safe.

	If you wish to retrieve the value, run a \plainview\sdk_broadcast\form2\form::unfilter_text() on it to return it to its original status.
...
trait value
{
	...
	**/
	public function get_filtered_post_value()
	{
		...
		return \plainview\sdk_broadcast\form2\form::filter_text( $value );
	}
