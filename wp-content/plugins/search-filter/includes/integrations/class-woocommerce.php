...
class WooCommerce {
	...
	public static function setup() {
		...
		add_filter( 'shortcode_atts_products', array( __CLASS__, 'shortcode_attributes' ), 10, 3 );
	...
	public static function shortcode_attributes( $out, $pairs, $atts ) {
		...
		$out['cache']          = false;
		self::$active_query_id = absint( $atts['search_filter_query_id'] );
