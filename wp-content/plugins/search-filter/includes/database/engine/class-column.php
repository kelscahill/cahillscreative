...
class Column extends Base {
	...
	/**
	 * Is this column a range?
	 *
	 * By default, columns do not support range queries. When `true`, the Query
	 * class will accept complex statements to help narrow results down to
	 * specific ranges for values in this column.
	 *
	 * @since 1.0.0
	 * @var   bool
	 */
	public $range_query = false;
	 ...
	 *     @type bool     $range_query    Is this column a range?
	...
	private function validate_args( $args = array() ) {
		...
		$callbacks = array(
			...
			'range_query'   => 'wp_validate_boolean',
