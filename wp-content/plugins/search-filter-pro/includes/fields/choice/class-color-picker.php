...
/**
 * Color picker field for filtering by color selection.
 */
class Color_Picker extends Choice {
	...
	public static function get_description() {
		return __( 'Allow users to filter options by choosing from a list of colors.' );
	}

	/**
	 * Supported styles for color picker field.
	 *
	 * @var array
	 */
