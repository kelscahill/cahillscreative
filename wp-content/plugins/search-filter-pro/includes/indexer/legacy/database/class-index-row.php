...
/**
 * Legacy Index Row Class.
 *
 * @since 3.0.0
 */
class Index_Row extends \Search_Filter_Pro\Database\Engine\Row {
	/**
	 * The ID of the field.
	 *
	 * @since 3.0.0
	...
	public function __construct( $item ) {
		...
		$this->date_modified    = ( false === $this->date_modified || empty( $this->date_modified ) ) ? 0 : strtotime( (string) $this->date_modified );
