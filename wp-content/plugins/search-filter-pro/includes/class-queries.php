...
class Queries {
	...
	public static function query_check_for_indexer_changes( $updated_instance, $section ) {
		...
		// Check to see if the field relationship is changing so we can clear the caches.
		if ( self::instance_attribute_will_change( $updated_instance, 'fieldRelationship' ) ) {
