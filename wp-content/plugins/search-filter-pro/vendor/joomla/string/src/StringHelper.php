 ...
 */
namespace Search_Filter_Pro\Vendor\Joomla\String;
...
abstract class StringHelper
{
    ...
    public static function strcasecmp($str1, $str2, $locale = \false)
    {
        ...
        return strcoll(static::transcode(mb_strtolower($str1), 'UTF-8', $encoding), static::transcode(mb_strtolower($str2), 'UTF-8', $encoding));
    }
    /**
