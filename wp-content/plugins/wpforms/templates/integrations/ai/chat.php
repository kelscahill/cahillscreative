<?php
/**
 * WPForms AI Chat templates.
 *
 * Outputs `<script type="text/html">` blocks for the FAB and modal that
 * `chat.js` (`assets/js/integrations/ai/chat/chat.js`) stamps into the DOM
 * via `wp.template()` on admin pages where a chat surface is active.
 *
 * @since 2.0.0
 */
...
<script type="text/html" id="tmpl-wpforms-ai-chat-fab">
	<button id="wpforms-ai-chat-fab"
			...
			type="button"
			title="<?php esc_attr_e( 'Ask WPForms AI', 'wpforms-lite' ); ?>">
		...
		<span class="screen-reader-text"><?php esc_html_e( 'WPForms AI', 'wpforms-lite' ); ?></span>
	</button>
</script>
...
<script type="text/html" id="tmpl-wpforms-ai-chat-modal">
	<div id="wpforms-ai-chat-modal" class="wpforms-ai-chat-modal wpforms-ai-chat-modal-initial">
		...
		<div class="wpforms-ai-chat-modal-body">
			<wpforms-ai-chat mode="admin" field-id="admin" class="wpforms-ai-chat-light"></wpforms-ai-chat>
		</div>
	</div>
</script>
