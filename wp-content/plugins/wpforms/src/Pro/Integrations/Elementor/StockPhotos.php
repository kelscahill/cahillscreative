...
/**
 * Stock photos for Elementor widget for Pro.
 *
 * @since 1.9.6
 */
class StockPhotos {
	 ...
	 *
	 * Relative to the `wp-content/uploads/wpforms/` directory.
	 *
	 * @since 1.9.6
	 *
	 * @var string
	 */
	public const STOCK_PHOTOS_DIR_PATH = 'themes/stock-photos/';
	 ...
	 * @var string
	 */
	public const STOCK_PHOTOS_JSON_FILE = 'pictures.json';
	 ...
	 * @var string
	 */
	public const STOCK_PHOTOS_URL_PATH = 'https://wpforms.com/wp-content/themes/wpf-theme/images/wallpapers/';
	 ...
	 * @var string
	 */
	public const STOCK_PHOTOS_ZIP_FILES = [
		'stock-photos-1.zip',
		'stock-photos-2.zip',
	];
	...
	private function get_zip_urls(): array {
		 ...
		 */
		return (array) apply_filters( 'wpforms_pro_integrations_elementor_stock_photos_zip_urls', $urls );
	}
	...
	public function install( bool $force = false ): array {
		...
		// Set a 5-minute timeout for all files download and unzip.
	...
	public function get_pictures(): array {
		...
		// Get pictures data from a JSON file.
