<?php
/**
 * Elegant media queries style template.
 *
 * This template can be overridden by copying it to yourtheme/wpforms/emails/elegant-queries.php.
 *
...
require WPFORMS_PLUGIN_DIR . "assets/pro/css/emails/partials/elegant_media_queries{$min}.css";
...
@media (prefers-color-scheme: dark) {
	...
	h1, h2, h3, h4, h5, h6, a, .content .field-name {
	...
	body, table.body, p, td, th {
		color: <?php echo sanitize_hex_color( wpforms_generate_contrasting_color( $email_text_color_dark, 21, 17 ) ); ?> !important;
		font-family: <?php echo esc_attr( $email_typography_dark ); ?> !important;
	}
