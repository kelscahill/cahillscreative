<?php
/**
 * Tech media queries style template.
 *
 * This template can be overridden by copying it to yourtheme/wpforms/emails/tech-queries.php.
 *
...
require WPFORMS_PLUGIN_DIR . "assets/pro/css/emails/partials/tech_media_queries{$min}.css";
