...
class GiftCardActivity implements \JsonSerializable
{
     ...
     */
    public function setAdjustIncrementActivityDetails(?GiftCardActivityAdjustIncrement $adjustIncrementActivityDetails) : void
    {
     ...
     */
    public function setAdjustDecrementActivityDetails(?GiftCardActivityAdjustDecrement $adjustDecrementActivityDetails) : void
    {
     ...
     */
    public function setUnlinkedActivityRefundActivityDetails(?GiftCardActivityUnlinkedActivityRefund $unlinkedActivityRefundActivityDetails) : void
    {
     ...
     */
    public function setImportReversalActivityDetails(?GiftCardActivityImportReversal $importReversalActivityDetails) : void
    {
     ...
     */
    public function setTransferBalanceToActivityDetails(?GiftCardActivityTransferBalanceTo $transferBalanceToActivityDetails) : void
    {
     ...
     */
    public function setTransferBalanceFromActivityDetails(?GiftCardActivityTransferBalanceFrom $transferBalanceFromActivityDetails) : void
    {
