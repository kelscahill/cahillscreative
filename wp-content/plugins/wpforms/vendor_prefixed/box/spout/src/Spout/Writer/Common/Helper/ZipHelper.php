...
class ZipHelper
{
    ...
    {
        $this->addFileToArchiveWithCompressionMethod($zip, $rootFolderPath, $localFilePath, $existingFileMode, \ZipArchive::CM_DEFAULT);
    }
    /**
     * Adds the given file, located under the given root folder to the archive.
    ...
    {
        $this->addFileToArchiveWithCompressionMethod($zip, $rootFolderPath, $localFilePath, $existingFileMode, \ZipArchive::CM_STORE);
    }
    /**
     * Adds the given file, located under the given root folder to the archive.
     * The file will NOT be compressed.
