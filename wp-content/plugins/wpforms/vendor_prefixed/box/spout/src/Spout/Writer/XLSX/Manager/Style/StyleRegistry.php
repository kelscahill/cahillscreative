...
class StyleRegistry extends \WPForms\Vendor\Box\Spout\Writer\Common\Manager\Style\StyleRegistry
{
    ...
    {
        return isset($this->styleIdToFillMappingTable[$styleId]) ? $this->styleIdToFillMappingTable[$styleId] : null;
    }
    /**
    ...
    {
        return isset($this->styleIdToBorderMappingTable[$styleId]) ? $this->styleIdToBorderMappingTable[$styleId] : null;
    }
    /**
     * @return array
     */
