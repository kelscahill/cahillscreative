...
namespace WPForms\Vendor\Box\Spout\Common\Helper;

use WPForms\Vendor\Box\Spout\Common\Exception\EncodingConversionException;
/**
...
class EncodingHelper
{
    ...
    public function __construct($globalFunctionsHelper)
    {
        ...
        $this->supportedEncodingsWithBom = [self::ENCODING_UTF8 => self::BOM_UTF8, self::ENCODING_UTF16_LE => self::BOM_UTF16_LE, self::ENCODING_UTF16_BE => self::BOM_UTF16_BE, self::ENCODING_UTF32_LE => self::BOM_UTF32_LE, self::ENCODING_UTF32_BE => self::BOM_UTF32_BE];
    }
    /**
