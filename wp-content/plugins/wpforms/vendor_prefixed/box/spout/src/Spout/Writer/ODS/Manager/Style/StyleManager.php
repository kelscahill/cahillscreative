...
use WPForms\Vendor\Box\Spout\Writer\ODS\Helper\BorderHelper;
/**
 * Class StyleManager
 * Manages styles to be applied to a cell
 */
class StyleManager extends \WPForms\Vendor\Box\Spout\Writer\Common\Manager\Style\StyleManager
{
    /** @var StyleRegistry */
...
EOD;
    ...
    private function getTextPropertiesSectionContent($style)
    {
        ...
        return '<style:text-properties ' . $this->getFontSectionContent($style) . '/>';
    }
    /**
    ...
    private function getParagraphPropertiesSectionContent($style)
    {
        ...
        return '<style:paragraph-properties ' . $this->getCellAlignmentSectionContent($style) . '/>';
    }
    /**
    ...
    {
        return \sprintf(' fo:text-align="%s" ', $this->transformCellAlignment($style->getCellAlignment()));
    }
    /**
