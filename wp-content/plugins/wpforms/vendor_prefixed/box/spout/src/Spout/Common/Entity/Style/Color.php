...
use WPForms\Vendor\Box\Spout\Common\Exception\InvalidColorException;
/**
 * Class Color
...
abstract class Color
{
    ...
    public static function rgb($red, $green, $blue)
    {
        ...
        return \strtoupper(self::convertColorComponentToHex($red) . self::convertColorComponentToHex($green) . self::convertColorComponentToHex($blue));
    }
    /**
