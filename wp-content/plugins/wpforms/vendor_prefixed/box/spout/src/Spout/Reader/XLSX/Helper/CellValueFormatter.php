...
namespace WPForms\Vendor\Box\Spout\Reader\XLSX\Helper;
...
class CellValueFormatter
{
    ...
    protected function isValidTimestampValue($timestampValue)
    {
        ...
        return $this->shouldUse1904Dates && $timestampValue >= -695055 && $timestampValue <= 2957003.9999884 || !$this->shouldUse1904Dates && $timestampValue >= -693593 && $timestampValue <= 2958465.9999884;
    }
    /**
