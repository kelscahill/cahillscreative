...
use WPForms\Vendor\Box\Spout\Writer\Common\Creator\ManagerFactoryInterface;
use WPForms\Vendor\Box\Spout\Writer\Common\Entity\Options;
use WPForms\Vendor\Box\Spout\Writer\Common\Manager\RowManager;
...
use WPForms\Vendor\Box\Spout\Writer\XLSX\Manager\SharedStringsManager;
use WPForms\Vendor\Box\Spout\Writer\XLSX\Manager\Style\StyleManager;
use WPForms\Vendor\Box\Spout\Writer\XLSX\Manager\Style\StyleRegistry;
use WPForms\Vendor\Box\Spout\Writer\XLSX\Manager\WorkbookManager;
use WPForms\Vendor\Box\Spout\Writer\XLSX\Manager\WorksheetManager;
/**
...
class ManagerFactory implements ManagerFactoryInterface
{
    ...
    private function createWorksheetManager(OptionsManagerInterface $optionsManager, StyleManager $styleManager, StyleMerger $styleMerger, SharedStringsManager $sharedStringsManager)
    {
        ...
        return new WorksheetManager($optionsManager, $rowManager, $styleManager, $styleMerger, $sharedStringsManager, $stringsEscaper, $stringsHelper, $this->entityFactory);
    }
    /**
     * @return SheetManager
     */
