...
namespace WPForms\Vendor\Box\Spout\Reader\ODS;
...
use WPForms\Vendor\Box\Spout\Reader\ODS\Creator\InternalEntityFactory;
...
class SheetIterator implements IteratorInterface
{
    ...
    private function isSheetActive($sheetName, $sheetIndex, $activeSheetName)
    {
        ...
        return $activeSheetName === null && $sheetIndex === 0 || $activeSheetName === $sheetName;
    }
    /**
    ...
    {
        return isset($this->sheetsVisibility[$sheetStyleName]) ? $this->sheetsVisibility[$sheetStyleName] : \true;
    }
    /**
