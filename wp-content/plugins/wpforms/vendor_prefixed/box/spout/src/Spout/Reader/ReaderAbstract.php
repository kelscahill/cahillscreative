...
namespace WPForms\Vendor\Box\Spout\Reader;
...
use WPForms\Vendor\Box\Spout\Reader\Exception\ReaderNotOpenedException;
/**
...
abstract class ReaderAbstract implements ReaderInterface
{
    ...
    protected function isSupportedStreamWrapper($filePath)
    {
        ...
        return $streamScheme !== null ? \in_array($streamScheme, $this->globalFunctionsHelper->stream_get_wrappers()) : \true;
    }
    /**
