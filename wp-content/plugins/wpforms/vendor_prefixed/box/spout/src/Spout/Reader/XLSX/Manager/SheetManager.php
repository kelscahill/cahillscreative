...
class SheetManager
{
    ...
    public function getSheets()
    {
        ...
        // By default, the first sheet is active
    ...
    protected function getSheetFromSheetXMLNode($xmlReaderOnSheetNode, $sheetIndexZeroBased, $isSheetActive)
    {
        ...
        return $this->entityFactory->createSheet($this->filePath, $sheetDataXMLFilePath, $sheetIndexZeroBased, $sheetName, $isSheetActive, $isSheetVisible, $this->optionsManager, $this->sharedStringsManager);
    }
    /**
