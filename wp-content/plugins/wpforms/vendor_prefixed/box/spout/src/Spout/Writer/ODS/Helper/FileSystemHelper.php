...
namespace WPForms\Vendor\Box\Spout\Writer\ODS\Helper;

use WPForms\Vendor\Box\Spout\Writer\Common\Entity\Worksheet;
use WPForms\Vendor\Box\Spout\Writer\Common\Helper\FileSystemWithRootFolderHelperInterface;
use WPForms\Vendor\Box\Spout\Writer\Common\Helper\ZipHelper;
use WPForms\Vendor\Box\Spout\Writer\ODS\Manager\Style\StyleManager;
use WPForms\Vendor\Box\Spout\Writer\ODS\Manager\WorksheetManager;
/**
 * Class FileSystemHelper
 * This class provides helper functions to help with the file system operations
 * like files/folders creation & deletion for ODS files
 */
class FileSystemHelper extends \WPForms\Vendor\Box\Spout\Common\Helper\FileSystemHelper implements FileSystemWithRootFolderHelperInterface
{
    ...
    {
        $this->createRootFolder()->createMetaInfoFolderAndFile()->createSheetsContentTempFolder()->createMetaFile()->createMimetypeFile();
    }
    /**
