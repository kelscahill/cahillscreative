...
namespace WPForms\Vendor\Box\Spout\Reader\XLSX;
...
use WPForms\Vendor\Box\Spout\Reader\Exception\InvalidValueException;
use WPForms\Vendor\Box\Spout\Reader\Exception\XMLProcessingException;
use WPForms\Vendor\Box\Spout\Reader\IteratorInterface;
...
use WPForms\Vendor\Box\Spout\Reader\XLSX\Helper\CellHelper;
use WPForms\Vendor\Box\Spout\Reader\XLSX\Helper\CellValueFormatter;
/**
 * Class RowIterator
 */
class RowIterator implements IteratorInterface
{
    ...
    protected function getRowIndex($xmlReader)
    {
        ...
        return $currentRowIndex !== null ? (int) $currentRowIndex : $this->lastRowIndexProcessed + 1;
    }
    /**
