...
namespace WPForms\Vendor\Box\Spout\Writer\XLSX\Manager\Style;

use WPForms\Vendor\Box\Spout\Common\Entity\Style\Color;
use WPForms\Vendor\Box\Spout\Common\Entity\Style\Style;
use WPForms\Vendor\Box\Spout\Writer\XLSX\Helper\BorderHelper;
/**
 * Class StyleManager
...
EOD;
    ...
    protected function getFillsSectionContent()
    {
        ...
        foreach ($registeredFills as $styleId) {
            ...
            $content .= \sprintf('<fill><patternFill patternType="solid"><fgColor rgb="%s"/></patternFill></fill>', $backgroundColor);
        }
        $content .= '</fills>';
        return $content;
    }
