var WPFormsForms=window.WPFormsForms||{};WPFormsForms.Overview=WPFormsForms.Overview||((t,o,l)=>{var a={},r={};let s=["analytics_views","analytics_interactions","analytics_conversion"];var m={init:function(){l(m.ready)},ready(){m.initElements(),m.initTableColumns(),m.initTagsFilter(),m.adjustBulkEditTagsForm(),m.initEditTagsBulkActionItem(),m.initFeatureTooltip(),m.events()},initElements(){a.$overview=l("#wpforms-overview"),a.$tagsFilterSelect=l(".wpforms-tags-filter select"),a.$tagsFilterButton=l(".wpforms-tags-filter button"),a.$listTableRows=l("#wpforms-overview #the-list"),a.$bulkEditTagsRows=l(".wpforms-bulk-edit-tags"),a.$bulkEditTagsForms=l(".wpforms-bulk-edit-tags .wpforms-edit-forms select"),a.$bulkEditTagsTags=l(".wpforms-bulk-edit-tags .wpforms-edit-tags select"),a.$bulkEditTagsMessage=l(".wpforms-bulk-edit-tags .wpforms-message"),a.$featureTooltip=l(".wpforms-education-feature-tooltip")},initTableColumns(){var e=a.$overview.find(".wp-list-table");e.find(".column-primary").removeClass("column-primary"),e.find(".column-name").addClass("column-primary")},initFeatureTooltip(){var e;a.$featureTooltip.length&&(a.$listTableRows.find('input[type="checkbox"]').length?(m.setFeatureTooltipCta(),m.alignFeatureTooltip(),(e=t.querySelector(".wp-list-table thead tr"))&&"undefined"!=typeof MutationObserver&&(r.featureTooltipObserver&&r.featureTooltipObserver.disconnect(),r.featureTooltipObserver=new MutationObserver(m.alignFeatureTooltip),r.featureTooltipObserver.observe(e,{childList:!0}))):a.$featureTooltip.remove())},setFeatureTooltipCta(){var e,t,s=a.$featureTooltip.find(".wpforms-education-feature-tooltip-view");s.length&&(e=a.$listTableRows.find('input[type="checkbox"]').first().val())&&((t=new URL(s.attr("href"),o.location.origin)).searchParams.set("form_id",e),s.attr("href",t.toString()))},getVisibleAnalyticsColumn(){for(var e of s){e=l("#"+e);if(e.is(":visible"))return e}return l()},alignFeatureTooltip(){var e,t,s=a.$featureTooltip;s&&s.length&&(e=l(".wpforms-table-container").first(),t=m.getVisibleAnalyticsColumn(),e.length&&t.length?(s.show(),WPFormsEducation.featureTooltip.anchorTo(s[0],t[0],e[0])):s.hide())},events(){a.$overview.on("click",".wp-list-table .delete a, .wp-list-table .duplicate a",m.confirmSingleAction).on("click",".button.delete-all",m.confirmSingleAction).on("click",".bulkactions #doaction",m.confirmBulkAction).on("click","#wpforms-reset-filter .reset",m.resetSearch).on("click",".wp-list-table .wpforms-locations-count, .wp-list-table .row-actions .locations, .wp-list-table .wpforms-locations-close",m.formsLocator).on("click","#the-list .wpforms-column-tags-edit",m.editTagsClick).on("click","#the-list .wpforms-column-tags-edit-cancel",m.cancelEditTagsClick).on("click","#the-list .wpforms-column-tags-edit-save",m.saveEditTagsClick).on("click","#the-list .wpforms-bulk-edit-tags-cancel",m.cancelBulkEditTagsClick).on("click","#the-list .wpforms-bulk-edit-tags-save",m.saveBulkEditTagsClick).on("click",".wpforms-tags-filter .button",m.tagsFilterClick).on("click",".wpforms-manage-tags",m.manageTagsClick).on("keydown",".wpforms-column-tags-form input, .wpforms-bulk-edit-tags input",m.addCustomItemInput).on("removeItem",".choices select",m.editTagsRemoveItem),a.$bulkEditTagsForms.on("removeItem",m.bulkEditTagsFormRemoveItem),l("#adv-settings").on("change","input.hide-column-tog",m.adjustBulkEditTagsForm).on("change","#tags-hide",m.toggleTagsColumn).on("change","input.hide-column-tog",()=>setTimeout(m.alignFeatureTooltip,0)),l(o).on("resize",_.debounce(m.adjustBulkEditTagsForm,200)).on("resize",_.debounce(m.alignFeatureTooltip,200)),l(t).on("change",".wpforms-manage-tags-items input",m.manageTagsItemChange).on("htmx:beforeSwap",m.htmxBeforeSwap).on("htmx:afterSettle",m.htmxAfterSettle)},htmxBeforeSwap(){a.$featureTooltip&&a.$featureTooltip.length&&a.$featureTooltip.detach().appendTo("body")},htmxAfterSettle(){m.initElements(),m.initTableColumns(),m.initTagsFilter(),m.adjustBulkEditTagsForm(),m.initEditTagsBulkActionItem(),m.initFeatureTooltip()},confirmSingleAction:function(e){e.preventDefault();var t,e=l(this),s=e.attr("href"),a=e.hasClass("delete-all")?wpforms_admin.form_delete_all_confirm:"",o=e.data("type")??"";""===a&&(t="template"===o?wpforms_admin.template_duplicate_confirm:wpforms_admin.form_duplicate_confirm,o="template"===o?wpforms_admin.template_delete_confirm:wpforms_admin.form_delete_confirm,a=e.parent().hasClass("delete")?o:t),m.confirmModal(a,{url:s})},confirmBulkAction:function(e){var t=l(this).closest("form"),s=t.find("#bulk-action-selector-top").val();"edit_tags"===s?(e.preventDefault(),m.openBulkEditTags()):"delete"===s&&(e.preventDefault(),m.confirmModal(wpforms_admin.form_delete_n_confirm,{bulk:!0,form:t}))},confirmModal:function(e,t){l.confirm({title:wpforms_admin.heads_up,content:e,icon:"fa fa-exclamation-circle",type:"orange",buttons:{confirm:{text:wpforms_admin.ok,btnClass:"btn-confirm",keys:["enter"],action:function(){t.url?o.location=t.url:t.bulk&&t.form.trigger("submit")}},cancel:{text:wpforms_admin.cancel,keys:["esc"]}}})},alertModal:function(e,t){var s=wpforms_admin_forms_overview.strings.error;l.confirm({title:t.title||wpforms_admin.oops||!1,content:e?s+"<br>"+e:s,icon:"fa fa-exclamation-circle",type:t.type||"orange",buttons:{confirm:{text:wpforms_admin.ok,btnClass:"btn-confirm",keys:["enter"]}}})},resetSearch:function(e){l("#wpforms-overview-search-term").val(""),l(this).closest("form").trigger("submit")},formsLocator:function(e){let t=l("#wpforms-overview-table .wpforms-locations-pane");e.preventDefault();var s,e=l(e.target.closest("tr")),a=t.prev().prev(),o=a.find(".row-actions");return 0<t.length&&(t.prev().remove(),t.remove(),o.removeClass("visible"),a.is(e))||0!==(a=e.find(".locations-list")).length&&(s=e.find("td:not(.hidden)").length,a=a.html(),s=`<th></th><td colSpan="${s}" class="colspanchange">
