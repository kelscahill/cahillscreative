...
class Settings
{
     ...
     */
    public function withMultibyteSupport(bool $multibyteSupport = \true) : self
    {
     ...
     * @return $this fluent interface
     */
    public function withLenientParsing(bool $usesLenientParsing = \true) : self
    {
