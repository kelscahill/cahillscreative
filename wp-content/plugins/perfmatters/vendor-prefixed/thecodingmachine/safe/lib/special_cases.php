...
use Perfmatters\Vendor\Safe\Exceptions\ExecException;
use Perfmatters\Vendor\Safe\Exceptions\FtpException;
use Perfmatters\Vendor\Safe\Exceptions\MiscException;
use Perfmatters\Vendor\Safe\Exceptions\PosixException;
use Perfmatters\Vendor\Safe\Exceptions\SocketsException;
use Perfmatters\Vendor\Safe\Exceptions\ApcuException;
use Perfmatters\Vendor\Safe\Exceptions\JsonException;
use Perfmatters\Vendor\Safe\Exceptions\OpensslException;
use Perfmatters\Vendor\Safe\Exceptions\PcreException;
use Perfmatters\Vendor\Safe\Exceptions\SimplexmlException;
use Perfmatters\Vendor\Safe\Exceptions\FilesystemException;
use Perfmatters\Vendor\Safe\Exceptions\HashException;
