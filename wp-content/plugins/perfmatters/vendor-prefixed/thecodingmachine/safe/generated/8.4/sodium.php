...
use Perfmatters\Vendor\Safe\Exceptions\SodiumException;
/**
...
{
    \error_clear_last();
    $safeResult = \Perfmatters\Vendor\sodium_crypto_aead_aegis128l_decrypt($ciphertext, $additional_data, $nonce, $key);
    if ($safeResult === \false) {
...
{
    \error_clear_last();
    $safeResult = \Perfmatters\Vendor\sodium_crypto_aead_aegis256_decrypt($ciphertext, $additional_data, $nonce, $key);
    if ($safeResult === \false) {
        throw SodiumException::createFromPhpError();
    }
    return $safeResult;
