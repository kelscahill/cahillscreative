 ...
 * @internal
 */
function odbc_connect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER) : \Perfmatters\Vendor\Odbc\Connection
{
    \error_clear_last();
 ...
 * @internal
 */
function odbc_pconnect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER) : \Perfmatters\Vendor\Odbc\Connection
{
    \error_clear_last();
    if ($cursor_option !== \SQL_CUR_USE_DRIVER) {
