	...
	extends \threewp_broadcast\premium_pack\Plugin_Pack
{
	...
	public function get_plugin_classes()
	{
		...
		[
			...
			__NAMESPACE__ . '\\avada_builder\\Avada_Builder',
			...
			__NAMESPACE__ . '\\bricks_builder\\Bricks_Builder',
			...
			__NAMESPACE__ . '\\code_snippets_pro\\Code_Snippets_Pro',
			__NAMESPACE__ . '\\contact_form_7\\Contact_Form_7',
			__NAMESPACE__ . '\\content_update_scheduler\\Content_Update_Scheduler',
			__NAMESPACE__ . '\\cornerstone\\Cornerstone',
			__NAMESPACE__ . '\\create\\Create',
			__NAMESPACE__ . '\\dear_flipbook\\Dear_Flipbook',
			...
			__NAMESPACE__ . '\\gutenberg\\Gutenberg',
			__NAMESPACE__ . '\\h5p\\H5P',
			__NAMESPACE__ . '\\icegram_engage\\Icegram_Engage',
			...
			__NAMESPACE__ . '\\jetengine\\JetEngine',
			...
			__NAMESPACE__ . '\\publishpress_future\\Publishpress_Future',
			...
			__NAMESPACE__ . '\\search_exclude\\Search_Exclude',
			...
			__NAMESPACE__ . '\\wp_job_manager\\WP_Job_Manager',
