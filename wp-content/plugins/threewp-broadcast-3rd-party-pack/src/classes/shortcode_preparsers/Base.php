	...
	extends \threewp_broadcast\premium_pack\base
{
	...
	**/
	...
	/**
	 * Return the ID separator, if any.
	 *
	 * @since		2024-11-02 07:15:27
	 **/
	public function get_id_separator()
	{
		return ',';
	}

	/**
	 * Convenience method to return all of the IDs from the ID attribute.
	 *
	 * @since		2024-11-02 07:28:03
	 **/
	public function get_ids( $item )
	{
		$id_attribute = $this->get_shortcode_id_attribute();
		$id_separator = $this->get_id_separator();
		$ids = explode( $id_separator, $item->attributes[ $id_attribute ] );
		return $ids;
	}
