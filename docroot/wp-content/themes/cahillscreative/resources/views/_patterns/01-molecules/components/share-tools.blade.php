<div class="article__share share-tools spacing--half">
  ...
  <a href="https://twitter.com/intent/tweet/?text={{ $title . ': ' . $excerpt . ' ' . $link }}&amp;url={{ $link }}" class="article__share-link icon icon--m space--half-right" aria-label="Share on Twitter" target="_blank">
  ...
  <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{ $link }}&amp;title={{ $title }}&amp;summary={{ $excerpt . ' ' . $link }}&amp;source={{ $link }}" aria-label="Share on LinkedIn" class="article__share-link icon icon--m space--half-right" target="_blank">
  ...
  <a href="https://pinterest.com/pin/create/button/?url={{ $link }}&amp;media={{ $image }}&amp;description={{ $title }}{{ ': ' . $excerpt . ' ' . $link }}" aria-label="Share on Pinterest" class="article__share-link icon icon--m space--half-right" target="_blank">
  ...
  <a href="mailto:?subject={{ $title }}&amp;body={{ $excerpt . ' ' . $link }}" target="_self" aria-label="Share by E-Mail" class="article__share-link icon icon--m space--half-right" target="_blank">
