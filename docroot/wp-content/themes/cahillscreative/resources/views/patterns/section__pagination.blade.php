  ...
  @if (!empty($prev_post))
    ...
    <a href="{{ $prev_link }}" class="article__nav-item previous">
      <div class="article__nav-item-label font--primary--xs">
        <span class="icon icon--xs">@include('patterns/arrow__previous')</span><font>Previous</font>
      </div>
...
<div class="article__nav--inner">
  @if (!empty($next_post))
    ...
    <a href="{{ $next_link }}" class="article__nav-item next">
      <div class="article__nav-item-label font--primary--xs">
        <font>Next</font><span class="icon icon--xs">@include('patterns/arrow__next')</span>
      </div>
