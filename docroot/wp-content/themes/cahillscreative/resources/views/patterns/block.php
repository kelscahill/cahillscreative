    ...
    <div class="block__toolbar">
      ...
      <div class="block__toolbar--right tooltip">
        ...
        <div class="block__toolbar-share-tooltip tooltip-wrap">
          ...
          <a aria-label="Share on Twitter" href="https://twitter.com/intent/tweet/?text=<?php echo $title; ?><?php echo ': ' . $excerpt . ' ' . $link; ?>&amp;url=<?php echo $link; ?>" class="tooltip-item"><span class="icon icon--xs space--half-right path-fill--black"><?php include(locate_template('patterns/icon__twitter.blade.php')); ?></span>Twitter</a>
          ...
          <a aria-label="Share by E-Mail" href="mailto:?subject=<?php echo $title; ?>&amp;body=<?php echo $excerpt . ' ' . echo $link; ?>" target="_self" class="tooltip-item"><span class="icon icon--xs space--half-right path-fill--black"><?php include(locate_template('patterns/icon__email.blade.php')); ?></span>Email</a>
