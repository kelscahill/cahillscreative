    ...
    <div class="block__toolbar">
      <div class="block__toolbar--left">
        <?php if (comments_open()): ?>
          <a href="<?php echo $link; ?>#comments" class="block__toolbar-item block__toolbar-comment space--half-right">
            <span class="icon icon--s space--half-right"><?php include(locate_template('patterns/icon--comment.blade.php')); ?></span>
      ...
      <div class="block__toolbar--right tooltip">
        <div class="block__toolbar-item block__toolbar-share tooltip-toggle js-toggle-parent">
          ...
          <span class="icon icon--s space--half-left"><?php include(locate_template('patterns/icon--share.blade.php')); ?></span>
        </div>
        <div class="block__toolbar-share-tooltip tooltip-wrap">
          ...
          <a aria-label="Share on Facebook" href="https://facebook.com/sharer/sharer.php?u=<?php echo $link; ?>&t=<?php echo $excerpt; ?>" class="tooltip-item"><span class="icon icon--xs space--half-right path-fill--black"><?php include(locate_template('patterns/icon--facebook.blade.php')); ?></span>Facebook</a>
          <a aria-label="Share on Twitter" href="https://twitter.com/intent/tweet/?text=<?php echo $title; ?><?php echo ': ' . $excerpt . ' ' . $link; ?>&amp;url=<?php echo $link; ?>" class="tooltip-item"><span class="icon icon--xs space--half-right path-fill--black"><?php include(locate_template('patterns/icon--twitter.blade.php')); ?></span>Twitter</a>
          <a aria-label="Share on Pinterest" href="https://pinterest.com/pin/create/button/?url=<?php echo $link; ?>&amp;media=<?php echo $image_medium; ?>&amp;description=<?php echo $title; ?><?php echo ': ' . $excerpt . ' ' . $link;  ?>" class="tooltip-item"><span class="icon icon--xs space--half-right path-fill--black"><?php include(locate_template('patterns/icon--pinterest.blade.php')); ?></span>Pinterest</a>
          <a aria-label="Share on LinkedIn" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $link; ?>&amp;title=<?php echo $title; ?>&amp;summary=<?php echo $excerpt . ' ' . $link; ?>&amp;source=<?php echo $link; ?>" class="tooltip-item"><span class="icon icon--xs space--half-right path-fill--black"><?php include(locate_template('patterns/icon--linkedin.blade.php')); ?></span>LinkedIn</a>
          <a aria-label="Share by E-Mail" href="mailto:?subject=<?php echo $title; ?>&amp;body=<?php echo $excerpt . ' ' . $link; ?>" target="_self" class="tooltip-item"><span class="icon icon--xs space--half-right path-fill--black"><?php include(locate_template('patterns/icon--email.blade.php')); ?></span>Email</a>
