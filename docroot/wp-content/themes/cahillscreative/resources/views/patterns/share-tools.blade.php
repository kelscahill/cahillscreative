<div class="article__share share-tools spacing--half">
  ...
  <a href="https://pinterest.com/pin/create/button/?url={{ $link }}&amp;media={{ $image }}&amp;description={{ $title }}{{ ': ' . $excerpt }}" aria-label="Share on Pinterest" class="article__share-link icon icon--m space--half-right" target="_blank">
  ...
  <a href="mailto:?subject={{ $title }}&amp;body={{ $excerpt }}" target="_self" aria-label="Share by E-Mail" class="article__share-link icon icon--m space--half-right" target="_blank">
