          ...
          <div class="article__toolbar block__toolbar">
            ...
            <div class="block__toolbar--right">
              ...
              <?php if( !empty($next_post) ): ?>
                ...
                <a href="<?php echo e($link); ?>" class="font--primary--xs">Next Item<span class="icon icon--s path-fill--black"><?php echo $__env->make('patterns/arrow--carousel', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></span></a>
              <?php endif; ?>
