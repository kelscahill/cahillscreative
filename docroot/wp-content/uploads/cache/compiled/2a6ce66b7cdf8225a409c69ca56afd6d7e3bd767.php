<div class="article__share share-tools spacing--half">
  ...
  <a href="https://facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" class="article__share-link icon icon--m space--half-right" aria-label="Share on Facebook" target="_blank">
  ...
  <a href="https://twitter.com/intent/tweet/?text=<?php the_title(); ?><?php echo('–' . get_the_excerpt()); ?>&amp;url=<?php the_permalink(); ?>" class="article__share-link icon icon--m space--half-right" aria-label="Share on Twitter" target="_blank">
  ...
  <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php the_permalink(); ?>&amp;title=<?php the_title(); ?>&amp;summary=<?php echo(get_the_excerpt()); ?>&amp;source=<?php the_permalink(); ?>" aria-label="Share on LinkedIn" class="article__share-link icon icon--m space--half-right" target="_blank">
  ...
  <a href="https://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&amp;media=<?php echo wp_get_attachment_image_src(get_post_thumbnail_id(), 'horiz__4x3--m')[0]; ?>&amp;description=<?php the_title(); ?><?php echo('–' . get_the_excerpt()); ?>" aria-label="Share on Pinterest" class="article__share-link icon icon--m space--half-right" target="_blank">
  ...
  <a href="mailto:?subject=<?php the_title(); ?>&amp;body=<?php echo(get_the_excerpt()); ?>" target="_self" aria-label="Share by E-Mail" class="article__share-link icon icon--m space--half-right" target="_blank">
