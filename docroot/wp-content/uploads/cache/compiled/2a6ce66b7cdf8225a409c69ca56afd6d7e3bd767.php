<div class="article__share share-tools spacing--half">
  ...
  <a href="https://twitter.com/intent/tweet/?text=<?php echo e($title); ?><?php echo e(': ' . $excerpt); ?>&amp;url=<?php echo e($link); ?>" class="article__share-link icon icon--m space--half-right" aria-label="Share on Twitter" target="_blank">
  ...
  <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo e($link); ?>&amp;title=<?php echo e($title); ?>&amp;summary=<?php echo e(': ' . $excerpt); ?>&amp;source=<?php echo e($link); ?>" aria-label="Share on LinkedIn" class="article__share-link icon icon--m space--half-right" target="_blank">
  ...
  <a href="https://pinterest.com/pin/create/button/?url=<?php echo e($link); ?>&amp;media=<?php echo e($image); ?>&amp;description=<?php echo e($title); ?><?php echo e(': ' . $excerpt); ?>" aria-label="Share on Pinterest" class="article__share-link icon icon--m space--half-right" target="_blank">
  ...
  <a href="mailto:?subject=<?php echo e($title); ?>&amp;body=<?php echo e($excerpt); ?>" target="_self" aria-label="Share by E-Mail" class="article__share-link icon icon--m space--half-right" target="_blank">
