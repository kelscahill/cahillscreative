    ...
    <?php if(!empty($prev_post)): ?>
      ...
      <a href="<?php echo e($prev_link); ?>" class="article__nav-item previous">
        <div class="article__nav-item-label font--primary--xs">
          <span class="icon icon--xs"><?php echo $__env->make('patterns/arrow__previous', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></span><font>Previous</font>
        </div>
  ...
  <div class="article__nav--inner">
    <?php if(!empty($next_post)): ?>
      ...
      <a href="<?php echo e($next_link); ?>" class="article__nav-item next">
        <div class="article__nav-item-label font--primary--xs">
          <font>Next</font><span class="icon icon--xs"><?php echo $__env->make('patterns/arrow__next', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></span>
        </div>
